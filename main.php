...
//Block 11: Handles searches on the flight table  
	...
	/*This array will hold the variables for the searches on the flight table. The parameters are 
	checked in a set order and then bound - this allows all 16 combinations of flights from 
	more or less specific/general locations (including no specified location) to be checked*/
	$param_arr = array(); 
